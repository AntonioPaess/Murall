...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "flex-1 px-3 py-6 overflow-y-auto sidebar-hide-scrollbar",
        className
      )}
...
>(({ className, ...props }, ref) => {
  return <ul ref={ref} className={cn("space-y-1.5", className)} {...props} />;
});
...
>(
  (
    { className, asChild = false, isActive, variant = "default", ...props },
    ref
  ) => {
